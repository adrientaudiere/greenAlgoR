...
![Barplot comparing carbon footprint of computation with reference
activities like flights, streaming, and other everyday
activities](reference/figures/README-plot-basic-1.png)
...
#> Session footprint: 0.01993852 g CO2
cat("Session runtime:", fp_session$runtime_h, "hours\n")
#> Session runtime: 0.0006755556 hours
```
...
- **Getting Started**: See
  [`vignette("greenAlgoR-intro")`](https://adrientaudiere.github.io/greenAlgoR/articles/greenAlgoR-intro.md)
  for comprehensive examples
- **Targets Integration**: See
  [`vignette("targets-integration")`](https://adrientaudiere.github.io/greenAlgoR/articles/targets-integration.md)
...
The
[`ga_footprint()`](https://adrientaudiere.github.io/greenAlgoR/reference/ga_footprint.md)
function returns a list with detailed breakdown:
