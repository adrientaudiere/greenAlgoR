...
#   TDP_cpu_internal <- csv_from_url_ga("https://raw.githubusercontent.com/GreenAlgorithms/green-algorithms-tool/refs/heads/master/data/v2.2/TDP_cpu.csv")
#   ref_value_internal <- csv_from_url_ga("https://raw.githubusercontent.com/GreenAlgorithms/green-algorithms-tool/refs/heads/master/data/v2.2/referenceValues.csv")
#
#  #  usethis::use_data(carbon_intensity_internal, TDP_cpu_internal, ref_value_internal, internal = TRUE,overwrite = TRUE)
